...
public class ReportServiceImpl implements ReportService {
    ...
    public SalesTop10ReportVO getSalesTop10(LocalDate begin, LocalDate end) {
        LocalDateTime beginTime= LocalDateTime.of(begin, LocalTime.MIN);//当天最开始的时间点
        LocalDateTime endTime= LocalDateTime.of(end, LocalTime.MAX);//当天最后的时间点
